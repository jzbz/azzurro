...
URL="https://github.com/jzbz/azzurro/releases/download/$TAG/azzurro-$TAG-macos-universal.zip"
...
SUMS_URL="https://github.com/jzbz/azzurro/releases/download/$TAG/SHA256SUMS"
